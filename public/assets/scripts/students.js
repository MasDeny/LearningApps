...
function show_table(response) {
    ...
    if (role == 'guru') {
        datarole +=
            '<a type="button" id="btn-statistik" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Statistik Siswa">' +
            '<i class="pe-7s-pen text-light">' +
            '</i></a>'
        } else {
            datarole +=
            '<a type="button" id="btn-edit" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Edit Siswa">' +
            '<i class="pe-7s-pen text-light">' +
            '</i></a>'+
...
function modal_detail(response) {
    ...
    $('#class').text('Kelas ' + response.class)
